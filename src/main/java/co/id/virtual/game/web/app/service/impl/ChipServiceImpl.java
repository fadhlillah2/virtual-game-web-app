...
public class ChipServiceImpl implements ChipService {
    ...
    public ChipBalanceDto getUserBalance(UUID userId) {
        return Observation.createNotStarted("chip.service.get.user.balance", observationRegistry)
                .contextualName("ChipService.getUserBalance")
                .lowCardinalityKeyValue("userId", userId.toString())
                .observe(() -> {
    ...
    public DailyBonusResponse claimDailyBonus(UUID userId) throws DailyBonusAlreadyClaimedException {
        return Observation.createNotStarted("chip.service.claim.daily.bonus", observationRegistry)
                .contextualName("ChipService.claimDailyBonus")
                .lowCardinalityKeyValue("userId", userId.toString())
                .observe(() -> {
                    User user = findUserById(userId);
    ...
    public GiftResponse sendGift(UUID senderId, UUID recipientId, Long amount) 
        ...
        return Observation.createNotStarted("chip.service.send.gift", observationRegistry)
                .contextualName("ChipService.sendGift")
                .lowCardinalityKeyValue("senderId", senderId.toString())
                .lowCardinalityKeyValue("recipientId", recipientId.toString())
                .highCardinalityKeyValue("amount", amount.toString())
                .observe(() -> {
    ...
    public Page<TransactionDto> getTransactionHistory(UUID userId, TransactionType type, Pageable pageable) {
        return Observation.createNotStarted("chip.service.get.transaction.history", observationRegistry)
                .contextualName("ChipService.getTransactionHistory")
                .lowCardinalityKeyValue("userId", userId.toString())
                .lowCardinalityKeyValue("transactionType", type != null ? type.name() : "ALL")
                .observe(() -> {
    ...
    public ChipBalanceDto addChips(UUID userId, Long amount, TransactionType type, String description, UUID referenceId) {
        return Observation.createNotStarted("chip.service.add.chips", observationRegistry)
                .contextualName("ChipService.addChips")
                .lowCardinalityKeyValue("userId", userId.toString())
                .lowCardinalityKeyValue("transactionType", type.name())
                .highCardinalityKeyValue("amount", amount.toString())
                .observe(() -> {
                    User user = findUserById(userId);
    ...
    public ChipBalanceDto subtractChips(UUID userId, Long amount, TransactionType type, String description, UUID referenceId) 
        ...
        return Observation.createNotStarted("chip.service.subtract.chips", observationRegistry)
                .contextualName("ChipService.subtractChips")
                .lowCardinalityKeyValue("userId", userId.toString())
                .lowCardinalityKeyValue("transactionType", type.name())
                .highCardinalityKeyValue("amount", amount.toString())
                .observe(() -> {
